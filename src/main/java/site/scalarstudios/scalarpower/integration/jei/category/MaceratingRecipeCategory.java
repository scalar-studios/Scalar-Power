...
public class MaceratingRecipeCategory implements IRecipeCategory<RecipeHolder<MaceratingRecipe>> {
    ...
    public static final IRecipeHolderType<MaceratingRecipe> TYPE = IRecipeHolderType.create(ScalarPowerRecipes.MACERATING_RECIPE_TYPE);
    ...
    public MaceratingRecipeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.createDrawable(TEXTURE, TEXTURE_U, 0, BACKGROUND_WIDTH, BACKGROUND_HEIGHT);
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ScalarPowerBlocks.MACERATOR.asItem()));
    }

    @Override
    public IRecipeHolderType<MaceratingRecipe> getRecipeType() {
        return TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.scalarpower.macerating");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<MaceratingRecipe> recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(RecipeHolder<MaceratingRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
