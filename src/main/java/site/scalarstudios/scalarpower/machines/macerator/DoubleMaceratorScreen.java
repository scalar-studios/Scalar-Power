...
public class DoubleMaceratorScreen extends AbstractContainerScreen<DoubleMaceratorMenu> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("scalarpower", "textures/gui/generic_2to4.png");
    ...
    public DoubleMaceratorScreen(DoubleMaceratorMenu menu, Inventory inventory, Component title) {
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        int progressAPixels = maxProgress > 0 ? (int) ((float) PROGRESS_WIDTH * menu.getProgressA() / maxProgress) : 0;
        ...
        int progressBPixels = maxProgress > 0 ? (int) ((float) PROGRESS_WIDTH * menu.getProgressB() / maxProgress) : 0;
