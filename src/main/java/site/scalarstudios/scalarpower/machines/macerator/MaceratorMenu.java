...
public class MaceratorMenu extends AbstractContainerMenu {
    ...
    public MaceratorMenu(int id, Inventory inventory, FriendlyByteBuf buf) {
        this(id, inventory, (MaceratorBlockEntity) inventory.player.level().getBlockEntity(buf.readBlockPos()),
                new SimpleContainerData(4));
    }

    public MaceratorMenu(int id, Inventory inventory, MaceratorBlockEntity blockEntity, ContainerData data) {
        super(ScalarPowerMenus.MACERATOR_MENU.get(), id);
