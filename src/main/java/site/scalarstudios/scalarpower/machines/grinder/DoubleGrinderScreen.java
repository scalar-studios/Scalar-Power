...
public class DoubleGrinderScreen extends AbstractContainerScreen<DoubleGrinderMenu> {
    ...
    public DoubleGrinderScreen(DoubleGrinderMenu menu, Inventory inventory, Component title) {
